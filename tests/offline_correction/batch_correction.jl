...
file_hyperparams = JSON.parsefile("out/hyperparameters/py_hypers.json")
@show typeof(file_hyperparams["yaw"])
...
gp_corrections, hyperparameters = HybridZuptInsJl.compute_corrections(
    input_feature, true_outputs, HybridZuptInsJl.compute_gp_corrections, file_hyperparams; n_restarts_optimizer=0)
